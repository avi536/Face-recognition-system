...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\i2.jpeg")
        img = img.resize((400,130), Image.Resampling.LANCZOS)
        self.photoimg=ImageTk.PhotoImage(img)

        f_lbl1=Label(self.root,image=self.photoimg)
        f_lbl1.place(x=0,y=0,width=400,height=130)
  
        #2nd image
        img1=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\i5.jpeg")
        img1= img1.resize((400,130), Image.Resampling.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl2=Label(self.root,image=self.photoimg1)
        f_lbl2.place(x=400,y=0,width=400,height=130)
        
        #3rd image
        img2=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\i1.avif")
        img2= img2.resize((400,130), Image.Resampling.LANCZOS)
        self.photoimg2=ImageTk.PhotoImage(img2)

        f_lbl3=Label(self.root,image=self.photoimg2)
        f_lbl3.place(x=800,y=0,width=400,height=130)

        #bgd image
        img3=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\KIIT.jpeg")
        img3= img3.resize((1080,1080), Image.Resampling.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=130,width=1300,height=800)

        title_lbl=Label(bg_img,text="STUDENT DETAILS",font=("times new roman",30,"bold"),bg="white",fg="black")
        ...
        Left_frame.place(x=10, y=10, width=620, height=440)

        img_left=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\i1.avif")
        img_left= img_left.resize((570,10), Image.Resampling.LANCZOS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(Left_frame,image=self.photoimg2)
        f_lbl.place(x=5,y=0,width=570,height=10)
        ...
        class_Student_frame.place(x=5, y=120, width=600, height=290)

        # student id
        studentId_label=Label(class_Student_frame,text="StudentID:",font=("times new roman",13,"bold"),bg="white")
        studentId_label.grid(row=0,column=0,padx=8,pady=3,sticky=W)

        studentID_entry=ttk.Entry(class_Student_frame,textvariable=self.va_std_id,width=14,font=("times new roman",13,"bold"))
        studentID_entry.grid(row=0,column=1,padx=8,pady=3,sticky=W)
        ...
        #class_div_entry=ttk.Entry(class_Student_frame,textvariable=self.var_div,width=14,font=("times new roman",13,"bold"))
        ...
        #gender_entry=ttk.Entry(class_Student_frame,textvariable=self.var_gender,width=14,font=("times new roman",13,"bold"))
        ...
        email_entry=ttk.Entry(class_Student_frame,textvariable=self.var_email,width=14,font=("times new roman",13,"bold"))
        ...
        address_entry=ttk.Entry(class_Student_frame,textvariable=self.var_address,width=14,font=("times new roman",13,"bold"))
        ...
        btn_frame.place(x=5,y=200,width=590,height=30)
        ...
        btn_frame1.place(x=5,y=232,width=590,height=30)
        ...
        Right_frame.place(x=640, y=10, width=600, height=440)

        img_right=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\i1.avif")
        img_right=img_right.resize((570,10), Image.Resampling.LANCZOS)
        ...
        search_combo=ttk.Combobox(Search_frame,font=("times new roman",13,"bold"),state="readonly",width=6)
        ...
        table_frame.place(x=5, y=75, width=585, height=330)
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.va_std_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Adity@536harsh",database="face_recogniser")
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.va_std_id.get() == "":
            ...
            try:
                ...
                # ======= Load predefined data frontals from opencv=======

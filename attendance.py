...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\image_for_attendance_part1.jpg")
        img = img.resize((635,130), Image.Resampling.LANCZOS)
        self.photoimg=ImageTk.PhotoImage(img)

        f_lbl1=Label(self.root,image=self.photoimg)
        f_lbl1.place(x=0,y=0,width=635,height=130)
  
        #2nd image
        img1=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\image_for_attendance_part2.jpg")
        img1= img1.resize((635,130), Image.Resampling.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl2=Label(self.root,image=self.photoimg1)
        f_lbl2.place(x=635,y=0,width=635,height=130)
        
        #bgd image
        img3=Image.open(r"C:\Users\KIIT\Desktop\FACE_RECOGNITION_SYSTEM\images\image_for_attendance_part3.jpg")
        img3= img3.resize((1300,500), Image.Resampling.LANCZOS)
        ...
        left_inside_frame.place(x=5,y=5, width=600,height=300)
        
        # labels and entry
        # attendance id
        attendanceId_label=Label(left_inside_frame,text="AttendanceID:",font=("times new roman",13,"bold"),bg="white")
        attendanceId_label.grid(row=0,column=0,padx=8,pady=3,sticky=W)

        attendanceID_entry=ttk.Entry(left_inside_frame,width=14,textvariable=self.var_atten_id,font=("times new roman",13,"bold"))
        attendanceID_entry.grid(row=0,column=1,padx=8,pady=3,sticky=W)
